...
一般的に犬は**7歳前後からシニア期**に入るとされています。ただし、体の大きさによって老化のスピードは異なります。
...
「シニア犬はタンパク質を減らすべき」という古い常識がありますが、**現在の獣医栄養学ではこれは誤り**とされています。

筋肉を維持するためには、むしろ**若い犬と同等か、それ以上のタンパク質**が必要です。ただし、腎臓病がある場合は制限が必要なので、かかりつけの獣医師と相談してください。

**チェックポイント：**原材料の1〜2番目に「チキン」「サーモン」など実際の肉・魚が記載されているものを選ぶ。

### 2. 低脂肪・適正カロリー

基礎代謝が下がるため、カロリーは成犬期より**20〜30%少なめ**が目安です。高脂肪フードは肥満・膵炎のリスクになります。
...
老化の大きな原因は**活性酸素による酸化ストレス**です。ビタミンC・ビタミンE・ベータカロテンなどの抗酸化成分が配合されているかを確認しましょう。
...
**7歳になった時点で、健康診断と合わせてフードの見直し**をすることをおすすめします。血液検査で腎臓・肝臓・血糖値の数値を確認し、それに合ったフードを選ぶのが最も安全です。
...
急に変えると消化不良・下痢を引き起こすことがあります。**7〜10日かけて徐々に移行**しましょう。
